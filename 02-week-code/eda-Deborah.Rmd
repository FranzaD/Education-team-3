...
### Creating a preliminary linear models
...
So then maybe the appropriate question would be:
...
1. responses follow a normal distribution 
  * PLS scores histograms look approx. normal (check out ppt for wk2)
2. Observations are independent within and between groups
  * in terms of education, yes
3. errors/residuals are normally distributed with a constant variance
  * unsure of this
