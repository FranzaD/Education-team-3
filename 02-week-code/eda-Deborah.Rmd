...
```{r}
# this table as many different wave variables - gross, let's just go for wave.y.y 
#valuable_dataset %>% 
#  glimpse()

#need to add a wave variable, factor all 6
#mt_w6_cleaned %>% 
#  glimpse()

#nice wave variable HUZZAH
PLS_data %>% 
  glimpse()
```
...
anova_table <- full_join(valuable_dataset,mt_w6_cleaned, key = c(child_id, parent_id))
