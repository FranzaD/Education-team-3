...
wave 4 mto5c n=302, I would expect then approx 151 observations for this variable in the done dataframe. In the done dataframe I have only 177 obs and 60 NA values = 237 obs so there are 65 observations that have just completely disappeared (according to wave 4 codebook)
