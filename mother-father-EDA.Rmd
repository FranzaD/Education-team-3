...
## Interaction Plot of Parents Average Positive Media Beliefs
```{r}
data %>% 
  ggplot() +
...
## Interaction Plot of Parents Average Educational Media Benefits Beliefs
```{r}
data %>% 
  ggplot() +
  ...
  stat_summary(fun = mean, geom = "point") +
  stat_summary(fun = mean, geom = "line") +
  labs(title = "Parents Average Educational Media Benefits Beliefs", x = "Wave", y = "Parents Average Educational Media Benefits Beliefs") +
  theme_bw()
```
