...
=======
  select(par_id, child_id, state_welfare, unemployment_insurance, food_stamp, wic,
...
>>>>>>> 2827f4e557a4ce9cb8e742c46ea086dd79fff689
...
<<<<<<< HEAD
  select(par_id, child_id, wave , par_gen,
         household_others, adult_others, children_others,
         know_others, marital_status,recieve_childcare,
=======
...
parent_education <- parent_education %>%
  ...
  zap_labels(bg14) %>% # gets rid of default datatype
    mutate(par_id = as.character(parid),
         child_id  = as.character(childid),
         wave = as.factor(wave),
         parent_gender = as.factor(pargen),
         degree_cert_in_prog = as.factor(bg07f),
         #bg14 = case_when(
         #  bg14 == 0 ~ "no",
         #  bg14 == 1 ~ "yes"),
         parenting_class_taken = as.logical(bg14),
         highest_degree_completed = as.factor(bg16),
