...
bitsea_w2 <- read_dta("../data/wave-2-(12-mo)/31_BIT_w2.dta")
#wave_2_codebook <- read_excel("../data/wave-2-(12-mo)/BB2_w2_codebook.xls.xlsx")

bitsea_w6 <- read_dta("../data/wave-6-(24-mo)/BB2_W6_BIT.dta")
...
```{r}
saveRDS(bitsea_w2, file="../data/model_w2.dta")
saveRDS(bitsea_w6, file="../data/model_w6.dta")
saveRDS(valuable_dataset, file="../data/valuable_dataset.dta")
saveRDS(model_score, file="../data/scores_w1.dta")
```
