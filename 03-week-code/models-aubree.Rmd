...
dim(total_score_pred)

is.vector(total_score_pred)
is.vector(total_score_obs)

str(total_score_obs)

test <- data.frame(total_score_obs)$total_score_obs

total_score_pred <- as.data.frame(total_score_pred)

plot(total_score_pred$total_score_pred, test)
```
